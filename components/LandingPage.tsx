...
const LandingPage: React.FC<LandingPageProps> = ({ onSelectTool }) => {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#050505] font-brand relative overflow-auto">
      ...
      {/* Header */}
      <div className="relative z-10 border-b-4 border-[#EE4035] bg-black/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 md:px-8 py-6 md:py-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 border border-[#333] px-3 py-1 bg-[#111] skew-x-[-10deg]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 py-12 md:py-20">
        ...
        <div className="text-center mb-16 md:mb-20">
          <div className="inline-block bg-[#FFEA00] text-black text-xs md:text-sm font-black px-4 py-1 mb-6 transform -rotate-2 shadow-[4px_4px_0_#EE4035]">
            AI CREATIVE TOOLS
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          {tools.map((tool, index) => (
            <div
              key={tool.id}
              className={`group relative bg-black border-4 ${
                tool.available ? 'border-[#FFEA00] cursor-pointer' : 'border-[#333] cursor-not-allowed opacity-60'
            ...
            >
              ...
              {/* Action Button */}
              {tool.available ? (
                <div className="flex items-center gap-2 text-[#FFEA00] font-bold text-sm group-hover:gap-4 transition-all">
